...
const navLinks = [
    ...
    {
        text: "Open Data",
        href: "https://opendata.tanjungpinangkota.go.id",
        logo: "/logo_open.png"
    },
    {
        text: "Satu Data",
        href: "https://satudata.tanjungpinangkota.go.id",
        logo: "/logo_sdi.png"
    }
]
            ...
            <nav class="flex items-center justify-between w-full relative">
                ...
                <div class="inline-flex relative bg-inherit">
                    <NuxtLink to="/" class=" flex items-center gap-2">
                        ...
                        <span class="text-lg text-gray-700 dark:text-white"><strong>Data Tanjungpinang</strong></span>
                    </NuxtLink>
                </div>
                ...
                <div 
                    ...
                    <ul class="text-gray-700 dark:text-gray-100 w-full flex lg:items-center gap-y-4 lg:gap-x-8 flex-col lg:flex-row">
                        <AtomsNavLink v-for="navItem in navLinks" :href="navItem.href" :text="navItem.text" :logo="navItem.logo"/>
                    </ul>
                </div>
